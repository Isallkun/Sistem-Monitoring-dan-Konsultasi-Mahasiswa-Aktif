...
<head>
  ...
  <title>Ketua Jurusan | SI Monitoring Ubaya</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{url('data_pengguna/'. Session::get('profil_ketuajurusan') )}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href='#'>{{Session::get('ketuajurusan')}}</a>
          <br>
          
          <a href="#" style="font-size: 14px">
          @if(Session::get('ketuajurusan') != "")
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('ketuajurusan')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{url('ketuajurusan/submaster/mahasiswa')}}" class="nav-link">
