...
<head>
  ...
  <title>Dosen | SI Monitoring Ubaya</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{url('data_pengguna/'. Session::get('profil_dosen') )}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href='#'>{{Session::get('dosen')}}</a>
          <br>
          
          <a href="#" style="font-size: 14px">
          @if(Session::get('dosen') != "")
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{url('dosen/data/mahasiswa')}}" class="nav-link">
