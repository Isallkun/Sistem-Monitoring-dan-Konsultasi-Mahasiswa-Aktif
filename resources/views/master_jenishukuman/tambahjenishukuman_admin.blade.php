        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('admin/master/jenishukuman/prosestambah')}}" role="form" method="post">
                {{ csrf_field() }}
